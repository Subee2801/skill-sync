...
---
🧪 How to Use
Upload a Job Description — paste text or upload a PDF
Upload Resumes — select one or more PDF/text files
Click Analyze — the app processes everything instantly
See Results:
